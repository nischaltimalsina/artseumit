        ...
        <div className='flex flex-col pt-44 pb-28 gap-x-12 gap-y-8 w-full max-w-screen-2xl mx-auto p-5 items-center '>
          ...
          <div className='flex flex-col'>
            <p className='text-lg font-light max-w-5xl text-center text-pretty'>
              ...
              provide exceptional IT solutions. Our first project, though
              challenging and yielding minimal profit, became the cornerstone of
              our commitment to excellence. We learned, we evolved, and we built
              upon that foundation, transforming Artseum into the trusted IT
              partner you see today.
            </p>
          </div>
        </div>
      </div>
