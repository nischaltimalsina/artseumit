    ...
    <>
      <div className='w-full py-20  bg-border'>
        <div className='flex flex-col gap-16  w-full max-w-screen-2xl mx-auto p-5 items-center'>
          <div className=' flex flex-col-reverse lg:flex-row gap-6 items-center lg:items-end'>
            <div className='flex flex-col gap-6'>
              ...
              <p className='font-light text-center max-w-2xl lg:text-start'>
                ...
                Dubai to leverage the power of technology for growth and
                success.
              </p>
            </div>
          ...
          <div className='flex flex-col lg:flex-row gap-6 items-center lg:items-end'>
            ...
            <div className='flex flex-col gap-6'>
              ...
              <p className='font-light text-pretty text-center max-w-2xl lg:text-start'>
